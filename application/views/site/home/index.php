...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="" class='product_title'>Các loại rượu</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
		  			<div class="product_item">
		  				<p class="product_name" ><a href="<?php echo base_url(); ?>/ruou-vang-c7" >RƯỢU VANG</a></p>
		  				<div class="product-image">
		  					<a href="<?php echo base_url(); ?>/ruou-vang-c7"><img src="https://static.kinhtedothi.vn/w960/images/upload/2023/06/22/ruou-vang-1122.jpg" alt="" class=""></a>
		  				</div>
						<a href="<?php echo base_url(); ?>/ruou-vang-c7"><button class='btn btn-info'><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Xem thêm</button></a>
		  			</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
		  			<div class="product_item">
		  				<p class="product_name" ><a href="<?php echo base_url(); ?>/ruou-manh-c8" >RƯỢU MẠNH</a></p>
		  				<div class="product-image">
		  					<a href="<?php echo base_url(); ?>/ruou-manh-c8"><img src="https://winecity.vn/wp-content/uploads/2022/03/ruou-manh-phap.jpg" alt="" class=""></a>
		  				</div>
						<a href="<?php echo base_url(); ?>/ruou-manh-c8"><button class='btn btn-info'><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Xem thêm</button></a>
		  			</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-3 col-lg-4">
		  			<div class="product_item">
		  				<p class="product_name" ><a href="<?php echo base_url(); ?>/ruou-pha-che-c9" >RƯỢU PHA CHẾ</a></p>
		  				<div class="product-image">
		  					<a href="<?php echo base_url(); ?>/ruou-pha-che-c9"><img src="https://dayphache.edu.vn/wp-content/uploads/2019/09/loai-ruou-mui-noi-tieng.jpg" alt="" class=""></a>
		  				</div>
						<a href="<?php echo base_url(); ?>/ruou-pha-che-c9"><button class='btn btn-info'><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Xem thêm</button></a>
		  			</div>
				</div>
	  	</div>  
	  </div>
